    ...
    return Scaffold(
      body: SafeArea(
        child: Stack(
          children: [
            Obx(
              ()=> loanController.lenderLoanLoading== true? CircularProgressbar(): Column(
                ...
                children: [
                  ...
                  Expanded(
                    child:
                         Container(
                           child: loanController.loanLendersModel.value.lenders?.length == 0?Center(
                             child: Text("No Lenders available",  style: TextStyle(
                               color: AppColors
                               .lightBlack,
                               fontSize:
                               Dimens.font_16sp,
