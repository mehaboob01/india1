                        ...
                        child: ListView(
                          ...
                          children: [
                            ...
                            CommonTextField(
                              ...
                              inputValidator: (value) {
                                return CommonValidations()
                                  ...
                                  minValue: redoCtrl.redeemPointsMinValue.value
                                      .round(),
                                );
                              ...
                              inputOnChanged: (inputValue) {
                                if (inputValue!.isNotEmpty) {
                                  ...
                                  redoCtrl.redeemPointsSliderValue.value = 0;
                                }
                              },
                            ),
                            SizedBox(
                            ...
                            redoCtrl.isSelectedBoolList[0]
                                ? BankAccoutCard(
                                    formkey: redoCtrl.accountFormKey)
                                : UpiVpaCard(),
                          ],
                        ),
                      );
                                  ...
                                  onPressed: () {
                                    if (cashbackManager.selectedIndex.value !=
                                      ...
                                      if (redoCtrl
                                        ...
                                        var bankId = checkBankId(redoCtrl
                                            .bankNameDropDownCtrl.value.text);
...
class _BankAccoutCardState extends State<BankAccoutCard> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      ...
      redoCtrl.bankNameDropDownCtrl.value.text = '';
  ...
  void onCardTapped(int index) {
    ...
    redoCtrl.bankNameDropDownCtrl.value.clear();
  ...
  bool toEnableButton() {
    if (bankTypeDropDownTapped == true &&
        cashbackCtrl.loyaltyBankAccountTextEditingCtrl.value.text.length >=
            9 && // here '9' is the min value of account number length
        cashbackCtrl
                    ...
                    children: [
                        ...
                        return CommonSearchTextField(
                            ...
                            fieldEnabled:
                                cashBackManager.selectedIndex.value != (-1)
                                    ? false
                                    : true,
                            label: bankAccontDropDownHint!,
                            hintText: "Select your bank here",
                            searchCtrl: redoCtrl.bankNameDropDownCtrl.value,
                            searchHintText: 'Select your Bank here...',
                            itemListNullError: 'Bank Name not Found');
                      }),
                      ...
                      CommonTextField(
                        ...
                        suffixIcon: GestureDetector(
                          onTap: () {
                            print(redoCtrl.bankNameDropDownCtrl.value.text);
                        ...
                        inputValidator: (value) {
                          if (value != null) {
                            return CommonValidations().numberValidation(
                                ...
                                minValLength: 9,
                                minLengthError:
                                    "Account Number should be between 9 to 18");
                          } else {
                            return null;
                          }
                        },
