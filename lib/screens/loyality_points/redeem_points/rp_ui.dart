                              ...
                              children: [
                                ...
                                Obx(() {
                                  return CommonToggleCard(
                                    ...
                                    redeemCardList: [
                                      RedeemCard(
                                        imageSvg: AppImages.mobilRechargeSvg,
                                        label: 'Mobile recharge',
                                        isSelected: isSelectedRedeemType[0],
                                      ),
                                      RedeemCard(

                                        imagePng: AppImages.walletIcon,
                                        label: 'Cashback',
                                        isSelected: isSelectedRedeemType[1],
                                      )
                                    ],
                                  );
                                })
                  ...
                  return ButtonWithFlower(
                    onPressed: () {
                      ...
                      if (redeemIndex == false) {
                        Get.snackbar('Oops!!', 'Select a way to redeem points');
                      }
                      if (isSelectedRedeemType.indexOf(redeemIndex) == 0) {
                    ...
                    iconToRight:
                    isSelectedRedeemType.any((element) => element == true)
                        ? true
                        : false,
