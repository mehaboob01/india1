  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        SafeArea(
          ...
          Obx(
           ()=> cashBackManager.isLoading == true ? CircularProgressbar():Expanded(
                child: ListView(
              shrinkWrap: true,
                                          ...
                                          CommonDeleteBottomSheet()
                                              .deleteBottomSheet(
                                                  ...
                                                  onDelete: () {
                                                    ...
                                                    print('Deleted ${cashBackManager.customerBankList[index].id} successfully');


                                                    cashBackManager.delBankAccount(cashBackManager.customerBankList[index].id);
