      ...
      () => IgnorePointer(
        ...
        child: Scaffold(
          ...
          body: Stack(children: [
                      ...
                      CustomActionIcons(
                          ...
                          onHeaderIconPressed: () async {
                            ...
                            Navigator.of(context)
                                .pushNamedAndRemoveUntil(MRouter.homeScreen,
                                    (Route<dynamic> route) => false)
                                .then((value) => startLoading.value = false);
                          })
                    ],
                  ),
                ),
            ...
            profileController.uploadProfileLoading.value == true ||
                    startLoading.value == true
                ? CircularProgressbar()
                : SizedBox()
          ]),
                ...
                Expanded(
                  child: Column(
                    ...
                    children: [
                      singleDetails(
                          title: "first_name".tr,
                          value: profileDetailsModel.firstName ??
                              "no_first_name".tr,
                  ...
                  child: Column(
                    ...
                    children: [
                      singleDetails(
                          title: "last_name".tr,
                          value:
                              profileDetailsModel.lastName ?? "no_last_name".tr,
                        ...
                        value: profileDetailsModel.dateOfBirth == null ||
                            ...
                            : DateFormat('dd-MM-yyyy').format(
                                DateFormat("yyyy-MM-dd")
                                    .parse(profileDetailsModel.dateOfBirth!)),
                      ),
                      singleDetails(
                ...
                : Container(
                    ...
                    child: Column(
                      ...
                      children: isBankAccountVisible.value == true
                          ? [
                              accountDetails(
                                  profileController.bankDetailsModel.value
                                          .preferredAccount ??
                                      PreferredAccount(),
                                  null),
                              if (profileController
                                          .bankDetailsModel.value.accounts !=
                                      null &&
                                  profileController
                                          .bankDetailsModel.value.accounts !=
                                      []) ...[
                                ...
                                ListView.builder(
                                  ...
                                  itemBuilder: (context, index) =>
                                      accountDetails(
                                          profileController.bankDetailsModel
