...
class CustomPopupMenuDivider extends CustomPopupMenuEntry<Never> {
  ...
  const CustomPopupMenuDivider({Key? key, this.height = _kMenuDividerHeight})
      : super(key: key);
...
class CustomPopupMenuItem<T> extends CustomPopupMenuEntry<T> {
  ...
  @override
  CustomCustomPopupMenuItemState<T, CustomPopupMenuItem<T>> createState() =>
      CustomCustomPopupMenuItemState<T, CustomPopupMenuItem<T>>();
}
...
class CustomCustomPopupMenuItemState<T, W extends CustomPopupMenuItem<T>>
    extends State<W> {
...
///
/// ```dart
/// CustomPopupMenuButton<Commands>(
...
///     }
///   },
///   itemBuilder: (BuildContext context) => <CustomPopupMenuEntry<Commands>>[
...
class CheckedCustomPopupMenuItem<T> extends CustomPopupMenuItem<T> {
  ...
  @override
  CustomCustomPopupMenuItemState<T, CheckedCustomPopupMenuItem<T>>
      createState() => _CheckedCustomCustomPopupMenuItemState<T>();
}

class _CheckedCustomCustomPopupMenuItemState<T>
    extends CustomCustomPopupMenuItemState<T, CheckedCustomPopupMenuItem<T>>
...
typedef CustomCustomPopupMenuItemSelected<T> = void Function(T value);
...
typedef CustomCustomPopupMenuItemBuilder<T> = List<CustomPopupMenuEntry<T>>
...
/// // not shown here).
/// CustomPopupMenuButton<WhyFarther>(
...
class CustomPopupMenuButton<T> extends StatefulWidget {
  ...
  final CustomCustomPopupMenuItemBuilder<T> itemBuilder;
  ...
  /// called instead.
  final CustomCustomPopupMenuItemSelected<T>? onSelected;
